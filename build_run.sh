...
DOCKER_RUN_CMD="docker run --privileged -d -e TAILSCALE_AUTHKEY=$TAILSCALE_AUTHKEY -e RCLONE_CONFIG_CONTENT=\"$RCLONE_CONFIG_CONTENT\" $DOCKER_HUB_USERNAME/$DOCKER_HUB_REPOSITORY:$TAG"
